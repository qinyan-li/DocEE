...
if __name__ == "__main__":
    ...
    template = get_event_template('zofund_without_trigger')

    build(template.event_type2event_class, 'train_double.json', 'zofund_train_without_trigger_double.json')
    build(template.event_type2event_class, 'dev_double.json', 'zofund_dev_without_trigger_double.json')
    build(template.event_type2event_class, 'submit_test_double.json', 'zofund_submit_without_trigger_double.json')
