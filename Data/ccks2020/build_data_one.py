...
if __name__ == "__main__":
    ...
    template = get_event_template('ccks2020_without_trigger_one')

    build(template.event_type2event_class, 'train_one.json', 'ccks2020_train_without_trigger_one.json')
    build(template.event_type2event_class, 'dev_one.json', 'ccks2020_dev_without_trigger_one.json')
    build(template.event_type2event_class, 'submit_test_one.json', 'ccks2020_submit_without_trigger_one.json')
