...
if __name__ == "__main__":
    ...
    template = get_event_template('ccks2021_without_trigger')

    build(template.event_type2event_class, 'train.json', 'ccks2021_train_without_trigger.json')
    build(template.event_type2event_class, 'dev.json', 'ccks2021_dev_without_trigger.json')
    build(template.event_type2event_class, 'submit_test.json', 'ccks2021_submit_without_trigger.json')
