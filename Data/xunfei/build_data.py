...
if __name__ == "__main__":
    ...
    template = get_event_template('xunfei_without_trigger')

    build(template.event_type2event_class, 'train.json', 'xunfei_train_without_trigger.json')
    build(template.event_type2event_class, 'dev.json', 'xunfei_dev_without_trigger.json')
    build(template.event_type2event_class, 'submit_test.json', 'xunfei_submit_without_trigger.json')
