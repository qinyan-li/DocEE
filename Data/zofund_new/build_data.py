...
if __name__ == "__main__":
    ...
    build(template.event_type2event_class, 'train.json', 'zofund_train_without_trigger.json')
    build(template.event_type2event_class, 'dev.json', 'zofund_dev_without_trigger.json')
    build(template.event_type2event_class, 'submit_test.json', 'zofund_submit_without_trigger.json', inference = True)
