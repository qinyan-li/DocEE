...

{
    ...
    if [[ -z "$GPUS" ]]; then
        ...
        CUDA_VISIBLE_DEVICES=${GPUS} python -u run_dee_task.py \
            ...
            --run_mode='ccks2021_without_trigger' \
            ...
            --inference_epoch=2 \
            --run_inference=False \
            --inference_dump_filepath='ccks2021_p1_submit_new.json' \
            --re_eval_flag=False \
            ...
            --event_type_template='ccks2021_without_trigger' \
            --use_span_lstm=True \
