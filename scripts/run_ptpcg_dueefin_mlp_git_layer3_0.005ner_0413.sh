...

{
    ...
    TASK_NAME='PTPCG_P1-DuEE_fin_MLP_git_layer3_0.005_ner_0413'
	...
	:'
        CUDA_VISIBLE_DEVICES=${GPUS} python -u run_dee_task.py \
            ...
            --inference_epoch=2 \
            --run_inference=False \
            --inference_dump_filepath='luge_p1_submit_new_mlp_0221.json' \
            --re_eval_flag=False \
	...
	'
        ...
        CUDA_VISIBLE_DEVICES=${GPUS} python -u run_dee_task.py \
            ...
            --inference_epoch=-1 \
            --run_inference=True \
	    --inference_dump_filepath='luge_p1_submit_new_mlp_git_layer3_ner0.005_0413.json' \
            --add_greedy_dec=False
