...

{
    ...
    TASK_NAME='PTPCG_P1-ccks2020_one'
    ...
    if [[ -z "$GPUS" ]]; then
        ...
        CUDA_VISIBLE_DEVICES=${GPUS} python -u run_dee_task.py \
            ...
            --run_mode='ccks2020_without_trigger_one' \
            ...
            --inference_epoch=2 \
            --run_inference=False \
            --inference_dump_filepath='ccks2020_p1_submit_new_one.json' \
            --re_eval_flag=False \
            ...
            --event_type_template='ccks2020_without_trigger_one' \
            --use_span_lstm=True \
