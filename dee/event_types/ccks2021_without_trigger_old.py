...
class event_0(BaseEvent):
	...
	TRIGGERS = {1: ['订单号'], 2: ['订单号', '身份证号'], 3: ['订单号', '身份证号', '手机号'], 4: ['订单号', '身份证号', '手机号', '受害人身份'], 5: ['订单号', '身份证号', '手机号', '受害人身份', '涉案平台'], 6: ['订单号', '身份证号', '手机号', '受害人身份', '涉案平台', '案发时间'], 7: ['订单号', '身份证号', '手机号', '受害人身份', '涉案平台', '案发时间', '案发城市'], 8: ['订单号', '身份证号', '手机号', '受害人身份', '涉案平台', '案发时间', '案发城市', '嫌疑人'], 9: ['订单号', '身份证号', '手机号', '受害人身份', '涉案平台', '案发时间', '案发城市', '嫌疑人', '受害人'], 10: ['订单号', '身份证号', '手机号', '受害人身份', '涉案平台', '案发时间', '案发城市', '嫌疑人', '受害人', '支付渠道'], 11: ['订单号', '身份证号', '手机号', '受害人身份', '涉案平台', '案发时间', '案发城市', '嫌疑人', '受害人', '支付渠道', '资损金额']} 
...
class event_1(BaseEvent):
	...
	TRIGGERS = {1: ['交易号'], 2: ['交易号', '银行卡号'], 3: ['交易号', '银行卡号', '手机号'], 4: ['交易号', '银行卡号', '手机号', '受害人身份'], 5: ['交易号', '银行卡号', '手机号', '受害人身份', '涉案平台'], 6: ['交易号', '银行卡号', '手机号', '受害人身份', '涉案平台', '案发时间'], 7: ['交易号', '银行卡号', '手机号', '受害人身份', '涉案平台', '案发时间', '案发城市'], 8: ['交易号', '银行卡号', '手机号', '受害人身份', '涉案平台', '案发时间', '案发城市', '嫌疑人'], 9: ['交易号', '银行卡号', '手机号', '受害人身份', '涉案平台', '案发时间', '案发城市', '嫌疑人', '受害人'], 10: ['交易号', '银行卡号', '手机号', '受害人身份', '涉案平台', '案发时间', '案发城市', '嫌疑人', '受害人', '支付渠道'], 11: ['交易号', '银行卡号', '手机号', '受害人身份', '涉案平台', '案发时间', '案发城市', '嫌疑人', '受害人', '支付渠道', '资损金额']} 
...
class event_2(BaseEvent):
	...
	TRIGGERS = {1: ['涉案平台'], 2: ['涉案平台', '案发时间'], 3: ['涉案平台', '案发时间', '案发城市'], 4: ['涉案平台', '案发时间', '案发城市', '嫌疑人'], 5: ['涉案平台', '案发时间', '案发城市', '嫌疑人', '支付渠道'], 6: ['涉案平台', '案发时间', '案发城市', '嫌疑人', '支付渠道', '资损金额']} 
...
class event_5(BaseEvent):
	...
	TRIGGERS = {1: ['受害人身份'], 2: ['受害人身份', '涉案平台'], 3: ['受害人身份', '涉案平台', '支付渠道'], 4: ['受害人身份', '涉案平台', '支付渠道', '资损金额']} 
