...
class event_0(BaseEvent):
   ...
   2: ['公司名称','受理法院'],
   3: ['公司名称','受理法院','公告时间'],
   4: ['公司名称','裁定时间','受理法院','公告时间'],
   5: ['裁定时间','公司行业','公告时间','公司名称','受理法院']}
...
class event_1(BaseEvent):
   ...
   2: ['公司名称','公告时间'],
   3: ['公司名称','损失金额','公告时间'],
   4: ['伤亡人数','公司名称','损失金额','公告时间'],
   5: ['伤亡人数','损失金额','其他影响','公告时间','公司名称']}
...
class event_3(BaseEvent):
   ...
   2: ['质押方','质押金额'],
   3: ['质押方','质押金额','质押结束日期'],
   4: ['质押方','接收方','质押金额','质押结束日期'],
   5: ['质押开始日期','质押方','接收方','质押金额','质押结束日期']}
...
class event_6(BaseEvent):
   ...
   2: ['公司名称','死亡年龄'],
   3: ['公司名称','死亡年龄','高层人员'],
   4: ['公司名称','死亡年龄','高层人员','死亡/失联时间'],
   5: ['高层职务','公司名称','死亡年龄','高层人员','死亡/失联时间']}
